...
import (
	...
	"github.com/nodebreaker0-0/liquidity/app/params"
	...
	liquidity "github.com/nodebreaker0-0/liquidity/app"
)
...
func newApp(logger log.Logger, db dbm.DB, traceStore io.Writer, appOpts servertypes.AppOptions) servertypes.Application {
	...
	return liquidity.NewliquidityApp(
		...
		liquidity.MakeEncodingConfig(), // Ideally, we would reuse the one created by NewRootCmd.
